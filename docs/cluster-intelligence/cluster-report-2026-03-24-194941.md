...
### Output Files
- Clusters: `docs/cluster-intelligence/clusters-2026-03-24-194941.csv`
- Intents: `docs/cluster-intelligence/intents-2026-03-24-194941.csv`
- Geos: `docs/cluster-intelligence/geos-2026-03-24-194941.csv`
- Opportunities: `docs/cluster-intelligence/opportunities-2026-03-24-194941.csv`
- Missing pages: `docs/cluster-intelligence/missing-pages-2026-03-24-194941.csv`
...
### Logs
- Productize log: `docs/cluster-intelligence/productize-log-2026-03-24-194941.txt`
- Outcomes: `docs/cluster-intelligence/outcomes-2026-03-24-194941.txt`
...
2. **Build missing pages** - use `docs/cluster-intelligence/missing-pages-2026-03-24-194941.csv` for high-demand gaps
